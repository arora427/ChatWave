...
import { useThemeStore } from './constants/useThemeStore.js'
...
const App = () => {
  ...
  return (
    <div className=' max-h-full text-5xl ' data-theme={theme}>
      ...
      <Routes>
        ...
        <Route path='/friends' element={isAuthenticated && isOnboarded ? (<Layout showSideBar={true}>
          <FriendsPage/></Layout>
        ): (
          <Navigate to={!isAuthenticated ? "/login" : '/onboarding'}/>
        )} />
