...
const {isPending, error,loginMutation}=useLogin()
  ...
  return (
    <div
      ...
      data-theme="night"
    >
      <div className="border border-primary/25 rounded-xl flex flex-col lg:flex-row w-full max-w-full mx-auto bg-base-100">
        {/* Login Form Section */}
          ...
          <div className="max-w-md p-8">
            ...
            <div className="text-center space-y-3 mt-6">
              ...
              <p className="opacity-70 text-xs">
                Catch up with friends, meet new people, and ride the ChatWave
                together.
              </p>
            </div>
          </div>
